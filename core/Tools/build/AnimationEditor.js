    ...
    function(
        ...
        var AnimationEditor = {
            ...
            initialize:function(){
                ...
                ReactDom.render(
                    React.createElement("div", {className: "form-group row"}, 
                        React.createElement("div", {className: "col-md-12"}, 
                            React.createElement(InputControls, {skin: "black-skin", onPlay: self.playAnimation, onPause: self.pauseAnimation, onStop: self.stopAnimation})
                        )
                    ),
                ...
                ReactDom.render(
                    React.createElement("div", {className: "form-group"}, 
                        React.createElement("div", {className: "btn-group col-md-12"}, 
                            React.createElement("a", {className: "btn btn-app", onClick: self.addObject}, 
                                React.createElement("i", {className: "fa fa-plus"}), 
                                "Objeto"
                            ), 
                            React.createElement("a", {className: "btn btn-app", onClick: self.showFrames}, 
                                React.createElement("i", {className: "fa fa-eye"}), 
                                "Mostrar Quadros"
                            ), 
                            React.createElement("a", {className: "btn btn-app", onClick: self.export}, 
                                React.createElement("i", {className: "fa fa-download"}), 
                                "Exportar Json"
                            ), 
                            React.createElement("a", {className: "btn btn-app btn-danger", onClick: self.removeFrames}, 
            ...
            addGraphics:function(urls){
                ...
                ReactDom.render(
                    React.createElement(Select, {options: self.graphics, onChange: self.changeGraphic, label: "Imagens"}),
            ...
            getFrameList:function(){
                ...
                if(self.frameList == null){
                    var props = {
                        ...
                        addon:React.createElement("button", {className: "btn btn-default pull-right", onClick: self.addFrame}, React.createElement("span", {className: "fa fa-plus"}))
                    };


                    ReactDom.render(
                        React.createElement(SequenceList, React.__spread({},  props)),
